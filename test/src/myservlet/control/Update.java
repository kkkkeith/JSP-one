...
public class Update extends HttpServlet{
   ...
   public void doPost(HttpServletRequest request,HttpServletResponse response)
     ...
     byte a[]=Gname.getBytes("gb2312");
     Gname=new String(a);
     byte b[]=Gdate.getBytes("gb2312");
     Gdate=new String(b);
     byte c[]=Gbid.getBytes("gb2312");
     Gbid=new String(c);
     byte d[]=Gprice.getBytes("gb2312");
     Gprice=new String(d);
     byte g[]=Gsell.getBytes("gb2312");
     Gsell=new String(g);
     byte f[]=Gstorage.getBytes("gb2312");
     Gstorage=new String(f);

     String goods= request.getParameter("goods");
     String condition="UPDATE goods SET Gdate = '"+Gdate+"'"
     		+ ", Gbid = '"+Gbid+"', Gprice = '"+Gprice+"' "
     		+ ",Gsell = '"+Gsell+"', Gstorage = '"+Gstorage+"'"
     		+ " where Gname = '"+Gname+"'";
     Connection con;
     Statement sql; 
     ResultSet rs;
