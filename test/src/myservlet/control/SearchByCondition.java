...
public class SearchByCondition extends HttpServlet{
   ...
   public void doPost(HttpServletRequest request,HttpServletResponse response) 
      ...
      String condition="";
      if(radioMess.equals("Gname")) {
          condition = 
         "SELECT * FROM goods where Gname ='"+searchMess+"'";
      }
      else if(radioMess.equals("Gname")) {
          condition = 
         "SELECT * FROM goods where Gname LIKE '%"+searchMess+"%'"; 
      }
      else if(radioMess.equals("Gprice")) {
          double max=0,min=0;
          ...
          condition =  "SELECT * FROM goods where "+
          "Gprice <= "+max+" AND Gprice>="+min ;
      }
   ...
   public void fail(HttpServletRequest request,HttpServletResponse response,
        ...
        try {
         ...
         out.println("返回：");
         out.println("<a href =searchGood.jsp>查询商品</a>");
